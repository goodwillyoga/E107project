...
We collected data between April 6th and April 29th for a period close to 4 weeks. Let us take a look at few datasets that we used in the project.
...
```
*TODO* - Move to appendix (main focus is on Stock Volatility)?
...
*TODO* - move to Appendix (this is irrelavant for the main discussion)
...
Let us look at daily closing prices/Volumes for the 3 choosen stocks (EIX, GS, IBM). These three stocks were previously investigated as part of Beta analysis which showed the role of beta in the underlying stock volatility.
...
*TODO* move this to the beginning of the Twitter Analysis.
...
[Misc Social Sentiment Analysis] (https://github.com/goodwillyoga/E107project/blob/master/project/Appendix.html)
