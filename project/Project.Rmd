...
From the above we can see that we have significant result for Closing Price ~ Sentiment Score for IBM as p-value <.05 and also confidence intervals do not include 0, so the relationship is significant. Let us try to look at the regression plots as well.
